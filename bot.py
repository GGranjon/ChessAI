...
piece_values_mg = { "P":82, "N":337, "B":365, "R":477, "Q":1025,  "K":12000}
piece_values_eg = { "P":94, "N":281, "B":297, "R":512, "Q":936,  "K":12000}
            ...
            for x in range(1,9):
                ...
                if id != None:
                    ...
                    if color == "w":
                        ...
                        white_eg_score+= tables[type][1][index] + piece_values_eg[type]
                    else:
